...
def get_llm_client():
    ...
    print(f"======{llm_config.llm_provider}======")
    ...
    if provider == LLMProvider.OPENAI:
        ...
        if not llm_config.llm_api_key.strip():
            # Allow empty API key for Ollama if endpoint is configured
            pass


        from .generic_llm_api.adapter import GenericAPIAdapter

        print(f"======return ollama modle:{llm_config.llm_endpoint}, {llm_config.llm_model}======")
